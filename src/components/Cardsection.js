    ...
    <div className="bg-gray-100 min-h-screen pt-4">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        {tutors.map((tutor, index) => (
          ...
          >
            <div className="h-52 bg-gray-200 rounded-t-lg relative flex items-center justify-center">
              <button
            ...
            <div className="mt-4 p-6">
              <div className="flex justify-between items-center">
                ...
                <span className="text-blue-600 font-semibold">{tutor.price}</span>
              </div>
              ...
              <p className="text-gray-600 text-sm mt-4">{tutor.description}</p>
