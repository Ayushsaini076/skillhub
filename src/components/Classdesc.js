...
const Classdesc = ({aboutclass,skill,associated}) => {
  // console.log(about)
  return (
    <div className="flex flex-col items-center bg-gray-100 p-10">
      <h2 className="text-3xl font-bold">About the Class</h2>
      <p className="text-gray-600 text-lg mt-2">Comprehensive {skill} Learning Experience</p>
      ...
      {/* <button className="bg-blue-500 text-white px-6 py-3 rounded-full mt-6 hover:bg-black">
