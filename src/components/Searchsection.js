...
const Searchsection = () => {
  return (
    <div className="flex flex-col items-center pt-[2rem] mt-14 h-[40vh] bg-gray-100">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2">Find Your Ideal Tutor</h1>
        <p className="text-gray-600">Search by skills</p>
      </div>
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-3xl">
        <div className="flex flex-col lg:flex-row items-center gap-4">
          <input
            type="text"
            placeholder="Search skills (e.g., sketching, Dance, Music)"
        ...
        <div className="mt-6">
          ...
          <div className="flex flex-wrap gap-2">
            {["sketching", "Dance", "Guitar", "yoga", "Music"].map((tag) => (
              <span
                key={tag}
